...
parallel --lb -j $CORES  PYTHONPATH=${PYPATH} python evaluations/learning/rnn_css/train_models_rnn_parallel.py {} 0 \
...
sleep 3
parallel --lb -j $CORES  PYTHONPATH=${PYPATH} python evaluations/learning/rnn_css/train_models_rnn_parallel.py {} 1 \
...
sleep 3
parallel --lb -j $CORES  PYTHONPATH=${PYPATH} python evaluations/learning/rnn_css/train_models_rnn_parallel.py {} 2 \
