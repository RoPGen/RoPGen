...
testattackpath = os.path.join(repo_path, "data", "test_githubc", "fold1")
#testattackpath = os.path.join(repo_path, "data", "dataset_2017", "dataset_test_unt_githubc", "fold1_20")
#testattackpath = os.path.join(repo_path, "data", "dataset_2017", "dataset_test_random_unt_java40", "5")
#testattackpath = os.path.join(repo_path, "data", "testattack_unt_cppgcj_folds", "fold3_204")
#testattackpath = '/home/hx/data/Mis/media/ramdisk/orig_cpp_plus_mcts/448/atest'
#testattackpath = '/home/hx/data/Mis/media/untargeted_3264486_5736519012712448/mcts'
#testattackpath = '/home/hx/data/code-imitator/data/testattack_unt3_gcjjava_1517'
#testattackpath = '/home/hx/data/code-imitator/data/testattack_unt_gcjjava_20/fold1'
    ...
    if find_author(src_author) == predicted:
        if not gen_testset_list and testset_list != []:
            for item in testset_list:
                ...
                # FIXME #7: Change how misclassified samples are excluded if you're testing on your own dataset.
