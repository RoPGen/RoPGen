...
class VarFctNameTransformer(AddTemplateTransformer):
    ...
    def __init__(self, transformer: str, option: str, uniqueid: str, fillcmdlineoption: str, transformersdir: str,
        ...
        includes_sources_ll = self._extract_includes(directory=sourcesdir, srcfiles=[file for file in sourceauthor.all_authiids_train if len(file.split('_')) <= 3], cmdargs=includecmdargs)
