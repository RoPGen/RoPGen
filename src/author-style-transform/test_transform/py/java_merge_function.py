...
def transform_by_line_cnt(src_author, dst_author, save_to='tmp.xml'):
    ...
    dst_avg_func_len = count_func_avg_len_by_author(dst_author)  #Record the average length of the target author function
    ...
    for file in file_list:
        ...
        for func in funcs:
            ...
            if func_len < dst_avg_func_len:
                short_funcs.append((func, func_len))  #Function nodes and distances shorter than the average function length of the target author
