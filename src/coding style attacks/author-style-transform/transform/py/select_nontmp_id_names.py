...
from transform.py import select_tmp_id_names
...
def select_both_id_names(src_author, dst_author, save_to = './style/transform.xml'):
...
def program_transform(path_program, path_author):
	transform_nontmp_id_names(path_program, path_author, ignore_list= [], save_to= './style/transform.xml')
	from transform import get_style
	get_style.cmd('mv ./style/transform.xml ./style/style.xml')
