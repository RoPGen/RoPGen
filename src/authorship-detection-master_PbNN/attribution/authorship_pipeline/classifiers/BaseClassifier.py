...
class BaseClassifier:
    ...
    def _split_train_test(self, loader: PathMinerLoader, fold_ind: Union[int, Tuple[int, int]] ,is_epoch_attack=False, pad: bool = False) \
        ...
        if self.config.mode() == 'time':
            ...
            if isinstance(test_size, int):
                ...
                #Judge whether to take the verification set or the test set
