...
#filePath = "/home/zss/data/project5/authorship-detection-master_java/datasets/gcj/test_dataset/"
...
'''
csv_output_path = "../../processed/gcj/tmp_epoch_csv/"
origin_path = "../../processed/gcj/train_dataset_5/cpp/"
new_path = csv_output_path+"cpp/"
out_path = "../../processed/gcj/tmp_epoch_csv/cpp/"
...
'''
csv_output_path = "/home/zss/data/project5/authorship-detection-master_epoch_nn_gcj5/processed/grad3/tem_tran_path/"
origin_path = "/home/zss/data/project5/authorship-detection-master_epoch_nn_gcj5/processed/grad3/tran_path/cpp/"
new_path = csv_output_path+"cpp/"
out_path = "/home/zss/data/project5/authorship-detection-master_epoch_nn_gcj5/processed/grad3/tran_path_select2/cpp/"
...
def generate_merge_CSV(filePath):
    csv_cmd = "java -jar /home/zss/data/project5/authorship-detection-master_java/attribution/pathminer/extract-path-contexts.jar snapshot --project "+filePath+" --output "+csv_output_path+"  --java-parser antlr --maxContexts 1000  --maxL 6 --maxW 2"
    p = subprocess.Popen(csv_cmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout,stderr = p.communicate()
    #print(stdout)
    #print("CSV generate success")
    merge()
    print(filePath+" CSV generate and merge success")
